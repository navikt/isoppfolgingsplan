...
inline fun <reified Deserializer> kafkaAivenConsumerConfig(kafkaEnvironment: KafkaEnvironment): Properties {
    return Properties().apply {
        putAll(commonKafkaAivenConfig(kafkaEnvironment))

        this[ConsumerConfig.GROUP_ID_CONFIG] = "isoppfolgingsplan-v1"
